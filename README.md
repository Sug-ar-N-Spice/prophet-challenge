...
# Develop a Supervised Machine Learning (ML) model
Logistic Regression Model and Random Forest Model

# Troubleshooting_forecasting_net_prophet vs forecasting_net_prophet.ipynb

The purpose of the Troubleshooting_forecasting_net_prophet file is to provide explict thought process as data scientist worked through this exercise. It is overly detailed and would not be ideal for presenting to other codes as it is not concise. However, Data Scientist "Freshers" may chose to keep seperate notes as to what they performed and then clean it up for presentation purposes. 
